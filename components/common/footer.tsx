...
export default function Footer() {
  return <div className={'bg-primary/30'}>
    <div className={'pt-[100px] pb-[80px] flex gap-[110px] justify-center container'}>
        <div className={'flex flex-col gap-[25px]'}>
            <Logo/>
            <p className={'opacity-50 max-w-[230px]'}>Did you come here for something in particular or just general Riker</p>
        </div>
      ...
      <p className={'py-[30px] text-center text-[12px] opacity-50'}>Designed By Themefisher & Developed By Gethugothemes</p>
      </div>
  </div>;
}
